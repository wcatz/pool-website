...
const missions = [
    ...
    { title: "Creating", subtitle: "content" },
    { title: "Encouraging", subtitle: "others" },
    { title: "Supporting", subtitle: "single pools" },
...
export default function HeroSection() {
    ...
    return (
        <div className="relative bg-blue-900 overflow-hidden pt-16 pb-16 sm:pb-24">
            ...
            >
                <svg
                    className="absolute bottom-0 right-0 transform translate-x-1/2 mb-48 text-gray-500 lg:top-0 lg:mt-28 lg:mb-0 xl:transform-none xl:translate-x-0"
                    width={364}
                    height={384}
                    viewBox="0 0 364 384"
                    fill="none"
                    ...
                    <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-4 lg:text-left lg:flex lg:items-center">
                        <div>
                            ...
                            <p class="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                                Developing the methods for financial freedom for all of the world.   
                            </p>
                        </div>
                    </div>
                </div>
