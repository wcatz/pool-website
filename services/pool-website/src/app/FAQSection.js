...
export default function FAQSection() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-800">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-300 dark:text-white">
        <div className="max-w-3xl mx-auto divide-y-2 divide-gray-200 text-gray-900 dark:text-gray-300 dark:text-white">
          <h2 className="text-center text-3xl font-extrabold text-gray-900 dark:text-gray-300 dark:text-white sm:text-4xl">
            FAQ
      </h2>
