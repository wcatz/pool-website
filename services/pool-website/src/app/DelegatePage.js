                ...
                <div className="space-y-10 mt-10">
                    <div className="space-y-4">
                        ...
                        <div className="space-x-4">
                            ...
                            <Button image="/coinbase.png" name="Kraken" href="https://coinbase.com" />
                        </div>
                    </div>
                    <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-500">Search for ticker OTG, select delegate and choose the wallet you want to use for staking</p>
                        <div className="space-x-4">
                            <Button image="/logo.png" name="SBLYR" href="https://adapools.org/pool/8264de3cdb1798dd8758e24cda5101184b44543e7c4421c7815f9ed8" />
                        </div>
                        <p className="text-gray-500">Or choose one of the many Alliance pools.</p>
                        <div className="space-x-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-500">You'll receive staking rewards every epoch (5 days)
                        </p>
                    </div>
                </div>
            </div>
