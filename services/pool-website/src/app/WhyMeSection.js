                                ...
                                <div className="pt-6">
                                    <div className="flow-root bg-white shadow rounded-lg px-6 pb-8 h-full flex-col">
                                        <div className="-mt-6 flex-grow">
                                            <div>
                                                <span className="inline-flex items-center justify-center p-3 bg-green-700 text-white rounded-md shadow-lg">
                                        ...
                                        <div className="mt-2">
                                            <div className="text-primary-700 underline text-xs">
